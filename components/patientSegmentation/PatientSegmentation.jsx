...
//     const prescribed = filteredPatients.filter(p => p.StatusPrespcription === "Celevida_Prescribed").length;
//     const nurture = filteredPatients.filter(p => p.StatusPrespcription === "Celevida_Nurture").length;
//     const not_prescribed = filteredPatients.filter(p => !["Celevida_Prescribed", "Celevida_Nurture"].includes(p.StatusPrespcription)).length;

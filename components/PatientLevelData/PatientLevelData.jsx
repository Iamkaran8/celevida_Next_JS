...
export const PatientLevelData = ({ patientData }) => {
    ...
    const parameterMap = [
        ...
        { label: "FBG", values: [patient.FBG, patient.FBG_Month_1, patient.FBG_Month_2, patient.FBG_Month_3] },
        ...
        { label: "Usage frequency", values: [patient.Usage_frequency_Month_1, patient.Usage_frequency_Month_2, patient.Usage_frequency_Month_3, patient.Usage_frequency_Month_4] },

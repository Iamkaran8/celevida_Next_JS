...
//     const parameterMap = [
//         { label: "Body Weight (kg)", values: [patient.Weight, patient.Body_Weight_kg_Month_1, patient.Body_Weight_kg_Month_2, patient.Body_Weight_kg_Month_3] },
...
//         { label: "Diet Recall (Avg Calorie)", values: [patient.DietRecall_Baseline, patient.DietRecall_1M, patient.DietRecall_2M, patient.DietRecall_3M] },
//         { label: "Calorie intake", values: [patient.hour_dietary_recall_calorie_intake, patient.hour_dietary_recall_calorie_intake_Month_1, patient.hour_dietary_recall_calorie_intake_Month_2, patient.hour_dietary_recall_calorie_intake_Month_3] },
//         { label: "Carb intake", values: [patient.hour_dietary_recall_carb_intake, patient.hour_dietary_recall_carb_intake_Month_1, patient.hour_dietary_recall_carb_intake_Month_2, patient.hour_dietary_recall_carb_intake_Month_3] },
//         { label: "Protein intake", values: [patient.hour_dietary_recall_protein_intake, patient.hour_dietary_recall_protein_intake_Month1, patient.hour_dietary_recall_protein_intake_Month2, patient.hour_dietary_recall_protein_intake_Month3] },
...
//     // Compute Diet Recall (Avg Calorie) dynamically per month
//     const dietRecallAvgByMonth = calorieIntake.map((_, index) => {
//         const sum = (calorieIntake[index] || 0) + (carbIntake[index] || 0) + (proteinIntake[index] || 0)
//         return Math.round(sum / 3) // rounded average
//     })
...
//     // Compute Diet Recall (Avg Calorie) dynamically per month
//     const dietRecallAvgByMonth = calorieIntake.map((_, index) => {
//         const sum = (Number(calorieIntake[index]) || 0) 
//                   + (Number(carbIntake[index]) || 0) 
//                   + (Number(proteinIntake[index]) || 0)
